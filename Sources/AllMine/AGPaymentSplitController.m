...
- (void)viewDidLoad
{
    ...
    _lbSum.font = [UIFont fontWithName:kFont2 size:50.0f];
    ...
    _lbError.font = [UIFont fontWithName:kFont2 size:20.0f];
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
  UIView* v = [[UIView alloc] init];
    if (section == [self numberOfSectionsInTableView:tableView]-1){
        ...
        v.frame = CGRectMake(0, 0, 320, [self tableView:tableView heightForFooterInSection:section]);
        
        //  title
        UILabel* lbTitle = [[UILabel alloc] initWithFrame:CGRectMake(35, 9, 250, v.frame.size.height)];
        lbTitle.font = [UIFont fontWithName:kFont1 size:12.0];
        lbTitle.textColor = [UIColor colorWithHex:kColorHexMudBlue];
        lbTitle.textAlignment = NSTextAlignmentLeft;
        lbTitle.backgroundColor = [UIColor clearColor];
        lbTitle.text = NSLocalizedString(@"PaymentSplitFooter", @"");
