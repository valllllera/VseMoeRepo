...
@interface AGTemplateEditController : UIViewController<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, UITextViewDelegate, AGSettingsCategoriesDelegate, AGAccountListControllerSelectDelegate>
