...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UILabel *cellLabel = [[UILabel alloc]initWithFrame:CGRectMake(22, 7.5, 320, 44)];
    ...
    switch (indexPath.section) {
        case 0:{
            ...
            switch (indexPath.row) {
                case 0:
                    ...
                    cellLabel.text = NSLocalizedString(@"SettingsSyncAuto", @"");
                    if ([usr.syncAuto boolValue]) {
                        cell.accessoryType = UITableViewCellAccessoryCheckmark;
                    }else{
                        cellLabel.textColor = [UIColor colorWithHex:kColorHexDarkGray];
                    }
                    break;
                default:
                    /*cell.textLabel.text = NSLocalizedString(@"SettingsSyncManual", @"");*/
                    cellLabel.text = NSLocalizedString(@"SettingsSyncManual", @"");
                    if (![usr.syncAuto boolValue]) {
                        cell.accessoryType = UITableViewCellAccessoryCheckmark;
                    }else{
                        cellLabel.textColor = [UIColor colorWithHex:kColorHexDarkGray];
        ...
        case 1:{
            ...
            cellLabel.text = NSLocalizedString(@"SettingsSyncWiFiOnly", @"");
...
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    switch (section) {
        case 0:
            return kTableHeaderStandardHeight+10;
