...
+ (UIBarButtonItem*) navigationBarButtonItemWithImageNamed:(NSString*)imgName target:(id)target action:(SEL)action{
    ...
    if([imgName isEqualToString:@"icon-sync-automat"]){
        [btn setBackgroundImage:[UIImage imageNamed:imgName] forState:UIControlStateHighlighted];
    }else
    {
...
+ (UIBarButtonItem*) navigationBarButtonItemWithTitle:(NSString*)title imageNamed:(NSString*)imgName target:(id)target action:(SEL)action{
    ...
    btn.titleLabel.font = [UIFont fontWithName:kFont1 size:11.0f];
...
+(UIView*) tableViewGroupedHeaderViewWithTitle:(NSString*)title
    ...
    //  title
    UILabel* lbTitle = [[UILabel alloc] initWithFrame:CGRectMake(35, 10.5, 270.0, v.frame.size.height)];
...
+(UIView*) tableViewGroupedFooterViewWithTitle:(NSString*)title
    ...
    //  title
    UILabel* lbTitle = [[UILabel alloc] initWithFrame:CGRectMake(55, 9, 210, v.frame.size.height)];
    lbTitle.font = [UIFont fontWithName:kFont1 size:12.0];
...
+(UIView*) tableViewHeaderViewWithTitle:(NSString*)title height:(double)height{
    ...
    //  title
    UILabel* lbTitle = [[UILabel alloc] initWithFrame:CGRectMake(25, 1, 290.0, v.frame.size.height)];
...
+ (BOOL) isReachableWithAlert{
    ...
    BOOL reachable3g = [self can3GConnect];
    
    if (!reachable && !reachable3g) {
...
#pragma mark - check for 3g connection
