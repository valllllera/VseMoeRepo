...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = NSLocalizedString(@"PasswordRecovery", nil);
    ...
    _lb1.textColor = [UIColor colorWithHex:kColorHexDarkBlue];
    _lb1.numberOfLines = 2;
    _lb1.text = NSLocalizedString(@"LoginPasswordRecover1", @"");

    _lb2.font = [UIFont fontWithName:kFont1 size:10.0];
    _lb2.textColor = [UIColor colorWithHex:kColorHexMudBlue];
