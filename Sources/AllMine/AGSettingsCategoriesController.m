...
- (void)viewDidLoad
{
    ...
    UIFont *fontForSG = [UIFont boldSystemFontOfSize:14.0f];
    NSDictionary *attributes = [NSDictionary dictionaryWithObject:fontForSG
                                                           forKey:UITextAttributeFont];
    [_sgCatType setTitleTextAttributes:attributes forState:UIControlStateNormal];
