...
- (id)initWithStyle:(UITableViewCellStyle)style
    ...
    if (self) {
        ...
        self.buttonCategory = [[UIButton alloc] initWithFrame:CGRectMake(15, 0, 140, cellHeight)];
        ...
        //
        self.buttonBalance = [[UIButton alloc] initWithFrame:CGRectMake(135, 0, 140, cellHeight)];
        self.buttonBalance.titleLabel.font = [UIFont fontWithName:kFont2
                                                size:23.0f];
